    ...
    <div className="pt-10 min-h-screen bg-gray-50 flex flex-col justify-center items-center px-4">
      <main className="w-full max-w-xl bg-white shadow-lg rounded-lg p-6 text-center">
        ...
        <h2 className="text-lg font-medium text-gray-800 mb-4">
          List Your <span className="text-green-600 font-semibold">Property</span> or <span className="text-green-600 font-semibold">Meal Service</span>
        </h2>

        <p className="text-sm text-gray-600 mb-4">
          Help thousands discover your PG, flat, or meal service with <span className="text-green-600 font-semibold">StayNMeal</span>. 
          Our AI-powered platform helps you reach seekers easily.
        </p>
